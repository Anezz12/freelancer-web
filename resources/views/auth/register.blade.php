<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="avatar" class="block mt-1 w-full" type="file" name="avatar" required autofocus autocomplete="occupation" />
        ...
        <div class="mt-4">
            ...
            <select id="role_id" name="role" class="py-3 rounded-lg pl-3 w-full border border-slate-300" required>
